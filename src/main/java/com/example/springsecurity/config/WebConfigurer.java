...
import com.example.springsecurity.config.properties.AppProperties;
...
public class WebConfigurer implements ServletContextInitializer,
    ...
    public WebConfigurer(Environment env, AppProperties jHipsterProperties) {
        this.env = env;
        this.appProperties = jHipsterProperties;
    }
